        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    src('oracle', 'Oracle', 'available', 'Read Oracle via the official `oracle` Rust crate (OCI). Opt-in: requires Oracle Instant Client installed on the build + runtime hosts, then rebuild Duckle with `cargo build --features oracle`. Prebuilt binaries do NOT include Oracle to keep the dep footprint manageable.'),
        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    snk('oracle', 'Oracle', 'available', 'INSERT to Oracle via the official `oracle` Rust crate. Same opt-in feature flag as src.oracle. Multi-row INSERT ALL ... SELECT 1 FROM dual idiom batched at 1000 rows.'),
